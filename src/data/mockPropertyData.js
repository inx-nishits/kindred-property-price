...
export const mockProperties = [
  // === VICTORIA ===
  {
    ...
    rentalEstimate: { weekly: { low: 600, mid: 650, high: 700 }, yield: 3.6 },
    suburb: 'Melbourne',
    state: 'VIC',
    postcode: '3000',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 480, mid: 520, high: 560 }, yield: 4.0 },
    suburb: 'South Yarra',
    state: 'VIC',
    postcode: '3141',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 660, mid: 720, high: 780 }, yield: 3.5 },
    suburb: 'Richmond',
    state: 'VIC',
    postcode: '3121',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 350, mid: 380, high: 410 }, yield: 4.2 },
    suburb: 'St Kilda',
    state: 'VIC',
    postcode: '3182',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 440, mid: 480, high: 520 }, yield: 4.1 },
    suburb: 'Carlton',
    state: 'VIC',
    postcode: '3053',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 1100, mid: 1200, high: 1300 }, yield: 2.7 },
    suburb: 'Armadale',
    state: 'VIC',
    postcode: '3143',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 780, mid: 850, high: 920 }, yield: 2.8 },
    suburb: 'Hawthorn',
    state: 'VIC',
    postcode: '3122',
  ...
  // === NEW SOUTH WALES ===
  {
    ...
    rentalEstimate: { weekly: { low: 530, mid: 580, high: 630 }, yield: 3.9 },
    suburb: 'Sydney',
    state: 'NSW',
    postcode: '2000',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 1000, mid: 1100, high: 1200 }, yield: 2.8 },
    suburb: 'Bondi Beach',
    state: 'NSW',
    postcode: '2026',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 480, mid: 520, high: 560 }, yield: 4.2 },
    suburb: 'Parramatta',
    state: 'NSW',
    postcode: '2150',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 720, mid: 780, high: 840 }, yield: 2.9 },
    suburb: 'Manly',
    state: 'NSW',
    postcode: '2095',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 780, mid: 850, high: 920 }, yield: 3.0 },
    suburb: 'Newtown',
    state: 'NSW',
    postcode: '2042',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 550, mid: 600, high: 650 }, yield: 3.7 },
    suburb: 'Crows Nest',
    state: 'NSW',
    postcode: '2065',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 570, mid: 620, high: 670 }, yield: 3.6 },
    suburb: 'Newcastle',
    state: 'NSW',
    postcode: '2300',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 620, mid: 680, high: 740 }, yield: 3.5 },
    suburb: 'Wollongong',
    state: 'NSW',
    postcode: '2500',
  ...
  // === QUEENSLAND ===
  {
    ...
    rentalEstimate: { weekly: { low: 500, mid: 550, high: 600 }, yield: 3.8 },
    suburb: 'Brisbane',
    state: 'QLD',
    postcode: '4000',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 440, mid: 480, high: 520 }, yield: 4.3 },
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 350, mid: 380, high: 410 }, yield: 4.7 },
  ...
  },
  {
    ...
    propertyType: 'Apartment',
    priceEstimate: { low: 850000, mid: 950000, high: 1050000 },
    rentalEstimate: { weekly: { low: 690, mid: 750, high: 810 }, yield: 4.1 },
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 780, mid: 850, high: 920 }, yield: 3.5 },
    suburb: 'Noosa Heads',
    state: 'QLD',
    postcode: '4567',
  ...
  },
  {
    ...
    propertyType: 'Apartment',
    priceEstimate: { low: 680000, mid: 750000, high: 820000 },
    rentalEstimate: { weekly: { low: 530, mid: 580, high: 630 }, yield: 4.0 },
    suburb: 'Broadbeach',
    state: 'QLD',
    postcode: '4218',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 500, mid: 550, high: 600 }, yield: 4.4 },
    suburb: 'Airlie Beach',
    state: 'QLD',
    postcode: '4802',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 380, mid: 420, high: 460 }, yield: 4.6 },
    suburb: 'Cairns',
    state: 'QLD',
    postcode: '4870',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 360, mid: 400, high: 440 }, yield: 4.8 },
    suburb: 'Townsville',
    state: 'QLD',
    postcode: '4810',
  ...
  // === SOUTH AUSTRALIA ===
  {
    ...
    propertyType: 'House',
    priceEstimate: { low: 520000, mid: 580000, high: 640000 },
    rentalEstimate: { weekly: { low: 380, mid: 420, high: 460 }, yield: 3.8 },
    suburb: 'Adelaide',
    state: 'SA',
    postcode: '5000',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 380, mid: 420, high: 460 }, yield: 4.1 },
    suburb: 'Glenelg',
    state: 'SA',
    postcode: '5045',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 500, mid: 550, high: 600 }, yield: 3.6 },
    suburb: 'Norwood',
    state: 'SA',
    postcode: '5067',
  ...
  // === WESTERN AUSTRALIA ===
  {
    ...
    rentalEstimate: { weekly: { low: 360, mid: 400, high: 440 }, yield: 4.0 },
    suburb: 'Perth',
    state: 'WA',
    postcode: '6000',
  ...
  },
  {
    ...
    propertyType: 'Townhouse',
    priceEstimate: { low: 720000, mid: 800000, high: 880000 },
    rentalEstimate: { weekly: { low: 530, mid: 580, high: 630 }, yield: 3.8 },
    suburb: 'Fremantle',
    state: 'WA',
    postcode: '6160',
  ...
  // === AUSTRALIAN CAPITAL TERRITORY ===
  {
    ...
    propertyType: 'Apartment',
    priceEstimate: { low: 620000, mid: 680000, high: 740000 },
    rentalEstimate: { weekly: { low: 500, mid: 550, high: 600 }, yield: 4.2 },
    suburb: 'Canberra',
    state: 'ACT',
    postcode: '2601',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 360, mid: 400, high: 440 }, yield: 4.5 },
    suburb: 'Braddon',
    state: 'ACT',
    postcode: '2612',
  ...
  // === TASMANIA ===
  {
    ...
    propertyType: 'Apartment',
    priceEstimate: { low: 580000, mid: 650000, high: 720000 },
    rentalEstimate: { weekly: { low: 440, mid: 480, high: 520 }, yield: 3.8 },
    suburb: 'Hobart',
    state: 'TAS',
    postcode: '7000',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 380, mid: 420, high: 460 }, yield: 4.0 },
    suburb: 'Launceston',
    state: 'TAS',
    postcode: '7250',
  ...
  // === NORTHERN TERRITORY ===
  {
    ...
    propertyType: 'Apartment',
    priceEstimate: { low: 380000, mid: 420000, high: 460000 },
    rentalEstimate: { weekly: { low: 410, mid: 450, high: 490 }, yield: 5.6 },
    suburb: 'Darwin',
    state: 'NT',
    postcode: '0800',
  ...
  },
  {
    ...
    rentalEstimate: { weekly: { low: 380, mid: 420, high: 460 }, yield: 5.5 },

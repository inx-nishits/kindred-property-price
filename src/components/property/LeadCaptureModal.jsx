        ...
        >
          ...
          <div className="mb-6">
            ...
            <div className="mt-4 p-3 bg-primary-50 rounded-lg">
              <p className="text-xs text-primary-700 font-medium mb-2">You'll get access to:</p>
              <ul className="text-xs text-muted-600 space-y-1">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Rental Estimate & Yield %
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-3 h-3 text-primary-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Comparable Sales & Suburb Insights
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-3 h-3 text-primary-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Nearby Schools & PDF Report
                </li>
              </ul>
            </div>
          </div>
